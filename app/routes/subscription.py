...
def create_checkout():
    ...
    session = s.checkout.Session.create(
        ...
        mode="subscription",
        success_url=f"{data.get('success_url', current_app.config.get('APP_BASE_URL', 'https://smartxray.onrender.com').rstrip('/') + '/dashboard')}?session_id={{CHECKOUT_SESSION_ID}}",
        cancel_url=data.get("cancel_url", current_app.config.get("APP_BASE_URL", "https://smartxray.onrender.com").rstrip("/") + "/pricing"),
